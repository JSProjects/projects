...
#psdg-header {
	...
	color:#FFF;
	font-size:6px;
	background: #0c2c65 url(/resources/images/head-bcg.jpg) no-repeat right top;	
	text-align:center;
}
...
#psdg-top {
	...
	background: #eff4ff url(/resources/images/top-light-blue.png) repeat-x left top;	
}
...
#psdg-middle {
	...
	padding: 0;
	width: 578px;
	background: #f6f6f6 url(/resources/images/center-bcg.png) repeat-y right top;	
}
...
.psdg-left {
	...
	color:#1f3d71;
	font: 13px Arial, Helvetica, sans-serif;
	background: #e4ebf8 url(/resources/images/center-blue.png) repeat-y left top;
}
...
#psdg-bottom {
	...
	height: 48px;
	border-top: 2px solid #FFF;
	background: #e4e3e3 url(/resources/images/bottom-line.png) repeat-x left top;	
}
...
<form name='f' commandName="keyrequest" action="/generate" method='GET'>
<section>

<!-- 
<div id="test"> -->
<h2>HiveManager NG Key Request Page</h2>
 <p>As an Aerohive employee, you can request (one) personal-use entitlement key (EK) for Cloud & VA. Once the key has been
requested you will receive and email within 24 hours that will include your EK. The key for Cloud is good for up 
to 10 devices for 1 year. We will renew your Cloud license on an annual basis as long as you are actively employed at Aerohive. 
The VA license is perpetual and good for upto 10 devices.</p>
<span class="psdg-bold"> Generate HM NG Key for 
<input type="radio" name="hmType" path="hmType" value="Cloud" checked>Cloud
<input type="radio" name="hmType" path="hmType" value="VA" >VA 	</span>
<input type="submit"  value="Generate" class="button_example">
<br/>
<br/>
<br/>
<!-- </div> -->
...
<%-- <caption>User Request History</caption> --%>
    	...
    	<br/>
	 <p style="color:red;">Note: You may request only one key at this time. However, for Cloud you will be able to request a 1-year renewal EK 30 days prior to the expiration of the previous key. If you need more than one Cloud/VA EK, please send an e-mail to 
