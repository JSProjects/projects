...
<!-- Home Section -->
		...
		<div id="tfheader">
			    ...
			    <ul id="crumbs">
					<c:if test ="${not empty sessionScope.endUserName}">
						...
						<c:if test ="${not empty sessionScope.hmid}">
   ...
   <display:table class="table blue" export="true" uid="activesupport" name="sessionScope.activesupport" sort="list" excludedParams="*"  pagesize="30">
      <display:caption>Active Support</display:caption>
    
                <display:column property="sku" title="Item"
                                sortable="true" sortName="sku" headerClass="sortable" />
                <display:column property="quantity" title="Units Purchased"
                                sortable="true" sortName="quantity" headerClass="sortable" />
                 <display:column property="endDate" title="End Date"
                                sortable="true" sortName="endDate" headerClass="sortable" />
                <display:column property="keyStatus" title="KeyStatus"
                                sortable="true" sortName="keyStatus" headerClass="sortable" />
                <display:setProperty name="export.csv.filename" value="ActiveSupportResult.csv" />
                <display:setProperty name="export.excel.filename" value="ActiveSupportResult.xls" />
   ...
   <display:table class="table blue" export="true" uid="expiredsupport" name="sessionScope.expiredsupport" sort="list" excludedParams="*"  pagesize="30">
    <display:caption>Expired Support</display:caption>
                <display:column property="sku" title="Item"
                                sortable="true" sortName="sku" headerClass="sortable" />
                <display:column property="quantity" title="Units Purchased"
                                sortable="true" sortName="quantity" headerClass="sortable" />
                ...
                <display:column property="keyStatus" title="KeyStatus"
                                sortable="true" sortName="keyStatus" headerClass="sortable" />
                <display:setProperty name="export.csv.filename" value="ExpiredSupportResult.csv" />
                <display:setProperty name="export.excel.filename" value="ExpiredSupportResult.xls" />
 				 <display:setProperty name="basic.msg.empty_list" value="" />
     </display:table>
   </div>
   </div>
   <div class="row">  
    <div class="col-xs-6">
       <display:table class="table blue" export="true" uid="subscription" name="sessionScope.subscriptionlist" sort="list" excludedParams="*"  pagesize="30">
     	<display:caption>Subscription </display:caption>
             <display:column property="sku" title="Item"
                                sortable="true" sortName="sku" headerClass="sortable" />
                <display:column property="quantity" title="Units Purchased"
                                sortable="true" sortName="quantity" headerClass="sortable" />
                 <display:column property="endDate" title="End Date"
                                sortable="true" sortName="endDate" headerClass="sortable" />
                <display:setProperty name="export.csv.filename" value="subscriptionResult.csv" />
                <display:setProperty name="export.excel.filename" value="subscriptionResult.xls" />
    			<display:setProperty name="basic.msg.empty_list" value="" />
     </display:table>
   </div>
   <div class="col-xs-6">
   
      <display:table class="table blue" export="true" uid="license" name="sessionScope.licenselist" sort="list" excludedParams="*"  pagesize="30">
    		<display:caption>License </display:caption>
             <display:column property="sku" title="Item"
                                sortable="true" sortName="sku" headerClass="sortable" />
                <display:column property="quantity" title="Units Purchased"
                                sortable="true" sortName="quantity" headerClass="sortable" />
                 <display:column property="endDate" title="End Date"
                                sortable="true" sortName="endDate" headerClass="sortable" />
                <display:setProperty name="export.csv.filename" value="licenseResult.csv" />
                <display:setProperty name="export.excel.filename" value="licenseResult.xls" />
   				 <display:setProperty name="basic.msg.empty_list" value="" />
     </display:table>
   </div>
   </div>
   ...
   <div class="col-xs-6">
     <div class="col-xs-6">
         <display:table class="table blue" export="true" uid="hardware" name="sessionScope.hardwarelist" sort="list" excludedParams="*"  pagesize="30">
     	 <display:caption>Hardware</display:caption>
                <display:column property="sku" title="Item"
                                sortable="true" sortName="sku" headerClass="sortable" />
                <display:column property="quantity" title="Units Purchased"
                                sortable="true" sortName="quantity" headerClass="sortable" />
                 <display:column property="unitsUsed" title="Units in Use"
                                sortable="true" sortName="unitsUsed" headerClass="sortable" />
                <display:setProperty name="export.csv.filename" value="hardwareResult.csv" />
                <display:setProperty name="export.excel.filename" value="hardwareResult.xls" />
   				 <display:setProperty name="basic.msg.empty_list" value="" />
     </display:table>
   </div>
   </div>
